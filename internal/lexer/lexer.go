// Code generated by re2go 4.3 on Thu Sep  4 15:33:14 2025, DO NOT EDIT.
//
...
func (l *Lexer) DumpState() string {
	...
	return fmt.Sprintf("ofs: %s, lastToken: %s\n", l.input[l.ofs:], sprintf(l.lastToken))
}
...
func (s *Scanner) IsEOF() bool {
	return s.Lexer.ofs >= len(s.Lexer.input)
}
