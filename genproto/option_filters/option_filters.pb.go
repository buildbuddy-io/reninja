...
func (OptionEffectTag) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_option_filters_proto_enumTypes[0].Descriptor()
}

func (OptionEffectTag) Type() protoreflect.EnumType {
	return &file_proto_option_filters_proto_enumTypes[0]
}
...
func (OptionEffectTag) EnumDescriptor() ([]byte, []int) {
	return file_proto_option_filters_proto_rawDescGZIP(), []int{0}
}
...
func (OptionMetadataTag) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_option_filters_proto_enumTypes[1].Descriptor()
}

func (OptionMetadataTag) Type() protoreflect.EnumType {
	return &file_proto_option_filters_proto_enumTypes[1]
}
...
func (OptionMetadataTag) EnumDescriptor() ([]byte, []int) {
	return file_proto_option_filters_proto_rawDescGZIP(), []int{1}
}

var File_proto_option_filters_proto protoreflect.FileDescriptor

const file_proto_option_filters_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/option_filters.proto\x12\aoptions*\xea\x02\n" +
...
var (
	...
	file_proto_option_filters_proto_rawDescData []byte
)

func file_proto_option_filters_proto_rawDescGZIP() []byte {
	file_proto_option_filters_proto_rawDescOnce.Do(func() {
		file_proto_option_filters_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_option_filters_proto_rawDesc), len(file_proto_option_filters_proto_rawDesc)))
	})
	return file_proto_option_filters_proto_rawDescData
}

var file_proto_option_filters_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_option_filters_proto_goTypes = []any{
	(OptionEffectTag)(0),   // 0: options.OptionEffectTag
	(OptionMetadataTag)(0), // 1: options.OptionMetadataTag
}
var file_proto_option_filters_proto_depIdxs = []int32{
...
func init() { file_proto_option_filters_proto_init() }
func file_proto_option_filters_proto_init() {
	if File_proto_option_filters_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_option_filters_proto_rawDesc), len(file_proto_option_filters_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_option_filters_proto_goTypes,
		DependencyIndexes: file_proto_option_filters_proto_depIdxs,
		EnumInfos:         file_proto_option_filters_proto_enumTypes,
	}.Build()
	File_proto_option_filters_proto = out.File
	file_proto_option_filters_proto_goTypes = nil
	file_proto_option_filters_proto_depIdxs = nil
}
