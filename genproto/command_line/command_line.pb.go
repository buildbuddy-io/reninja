...
func (x *CommandLine) Reset() {
	*x = CommandLine{}
	mi := &file_proto_command_line_proto_msgTypes[0]
...
func (*CommandLine) Descriptor() ([]byte, []int) {
	return file_proto_command_line_proto_rawDescGZIP(), []int{0}
}
...
func (x *CommandLineSection) Reset() {
	*x = CommandLineSection{}
	mi := &file_proto_command_line_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CommandLineSection) Descriptor() ([]byte, []int) {
	return file_proto_command_line_proto_rawDescGZIP(), []int{1}
}
...
func (x *ChunkList) Reset() {
	*x = ChunkList{}
	mi := &file_proto_command_line_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChunkList) Descriptor() ([]byte, []int) {
	return file_proto_command_line_proto_rawDescGZIP(), []int{2}
}
...
func (x *OptionList) Reset() {
	*x = OptionList{}
	mi := &file_proto_command_line_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OptionList) Descriptor() ([]byte, []int) {
	return file_proto_command_line_proto_rawDescGZIP(), []int{3}
}
...
func (x *Option) Reset() {
	*x = Option{}
	mi := &file_proto_command_line_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Option) Descriptor() ([]byte, []int) {
	return file_proto_command_line_proto_rawDescGZIP(), []int{4}
}
...
func (x *Option) GetEffectTags() []option_filters.OptionEffectTag {
	if x != nil {
		return x.EffectTags
	}
	return nil
...
func (x *Option) GetMetadataTags() []option_filters.OptionMetadataTag {
	if x != nil {
...
var File_proto_command_line_proto protoreflect.FileDescriptor

const file_proto_command_line_proto_rawDesc = "" +
	"\n" +
	"\x18proto/command_line.proto\x12\fcommand_line\x1a\x1aproto/option_filters.proto\"y\n" +
	"\vCommandLine\x12,\n" +
...
var (
	...
	file_proto_command_line_proto_rawDescData []byte
)

func file_proto_command_line_proto_rawDescGZIP() []byte {
	file_proto_command_line_proto_rawDescOnce.Do(func() {
		file_proto_command_line_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_command_line_proto_rawDesc), len(file_proto_command_line_proto_rawDesc)))
	})
	return file_proto_command_line_proto_rawDescData
}

var file_proto_command_line_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_command_line_proto_goTypes = []any{
	...
	(option_filters.OptionEffectTag)(0),   // 5: options.OptionEffectTag
	(option_filters.OptionMetadataTag)(0), // 6: options.OptionMetadataTag
}
var file_proto_command_line_proto_depIdxs = []int32{
...
func init() { file_proto_command_line_proto_init() }
func file_proto_command_line_proto_init() {
	if File_proto_command_line_proto != nil {
		return
	}
	file_proto_command_line_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_command_line_proto_rawDesc), len(file_proto_command_line_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_command_line_proto_goTypes,
		DependencyIndexes: file_proto_command_line_proto_depIdxs,
		MessageInfos:      file_proto_command_line_proto_msgTypes,
	}.Build()
	File_proto_command_line_proto = out.File
	file_proto_command_line_proto_goTypes = nil
	file_proto_command_line_proto_depIdxs = nil
}
